  ...
  try {
    ...
    for (const sheetConfig of config) {
      try {
        ...
        const daysRemaining = calculateDaysRemaining(currentSupplies, dailyConsumption);
        ...
        logger.info(`Successfully processed ${sheetConfig.name}: ${daysRemaining} days remaining`);
